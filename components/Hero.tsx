...
export default function Hero() {
  ...
  return (
    <section className="container mx-auto px-4 py-12 md:py-20 mt-[73px]">
      <div className="flex flex-col items-center md:flex-row">
        <div className="mb-10 md:mb-0 md:w-2/3">
          <h1 className="font-body text-3xl font-bold text-nord-0 md:text-5xl md:leading-tight">
            Mahtabul Al Nahian
          </h1>
          <h2 className="font-heading mt-4 text-xl text-nord-1 md:text-2xl letter-widers">
            <span className="text-nord-9">Chief Operating Officer (COO)</span> &
        ...
        <div className="md:w-1/3 flex justify-center">
          <div className="relative h-48 w-48 overflow-hidden rounded-full border-4 border-nord-4 md:h-64 md:w-64">
            {!profileImgError ? (
              ...
              <div className="flex h-full w-full items-center justify-center bg-nord-5">
                <svg
                  className="h-24 w-24 text-nord-3 md:h-32 md:w-32"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                  aria-hidden
                >
